...
{
  public ItemEncoder(SymbolDatabase db)
    throws IOException
  {
    super(db);
  ...
  {
    File patchFile = new File(Directories.MOD_ITEM_PATCH + moveName + ".bpat");
    File indexFile = new File(Directories.DUMP_ITEM_SRC + moveName + ".bidx");
    File rawFile = new File(Directories.DUMP_ITEM_RAW + moveName + ".bin");
    File outFile = new File(Directories.MOD_ITEM_TEMP + moveName + ".bin");
    File outIndexFile = new File(Directories.MOD_ITEM_TEMP + moveName + ".bidx");
