...
class LinuxNativeTypesMap
{
  ...
  public static Component.Identifier getRelAxisID(int nativeID)
  {
    ...
    try {
      ...
      System.out.println("INSTANCE.relAxesIDis only " + INSTANCErelAxesIDs.length + " long, so " + nativeID + " not contained");
    }
  ...
  public static Component.Identifier getAbsAxisID(int nativeID)
  {
    ...
    try {
      ...
      System.out.println("INSTANCE.absAxesIDs is only " + INSTANCEabsAxesIDs.length + " long, so " + nativeID + " not contained");
    }
  ...
  public static Component.Identifier getButtonID(int nativeID)
  {
    ...
    try {
      ...
      System.out.println("INSTANCE.buttonIDs is only " + INSTANCEbuttonIDs.length + " long, so " + nativeID + " not contained");
    }
