  ...
  implements DisplayImplementation
{
  ...
  {
    // Byte code:
    //   0: invokestatic 14	org/lwjgl/opengl/LinuxDisplay:lockAWT	()V
    //   3: invokestatic 15	org/lwjgl/opengl/LinuxDisplay:incDisplay	()V
    //   6: invokestatic 16	org/lwjgl/opengl/LinuxDisplay:isXF86VidModeSupported	()Z
    //   9: ifeq +21 -> 30
    //   12: invokestatic 17	org/lwjgl/opengl/LinuxDisplay:getDisplay	()J
    //   15: invokestatic 18	org/lwjgl/opengl/LinuxDisplay:getDefaultScreen	()I
    //   18: invokestatic 19	org/lwjgl/opengl/LinuxDisplay:nGetCurrentGammaRamp	(JI)Ljava/nio/ByteBuffer;
    //   21: astore_0
    //   22: invokestatic 20	org/lwjgl/opengl/LinuxDisplay:decDisplay	()V
    //   25: invokestatic 21	org/lwjgl/opengl/LinuxDisplay:unlockAWT	()V
    //   28: aload_0
    //   29: areturn
    //   30: aconst_null
    //   31: astore_0
    //   32: invokestatic 20	org/lwjgl/opengl/LinuxDisplay:decDisplay	()V
    //   35: invokestatic 21	org/lwjgl/opengl/LinuxDisplay:unlockAWT	()V
    //   38: aload_0
    //   39: areturn
    //   40: astore_1
    //   41: invokestatic 20	org/lwjgl/opengl/LinuxDisplay:decDisplay	()V
    //   44: aload_1
    //   45: athrow
    //   46: astore_2
    //   47: invokestatic 21	org/lwjgl/opengl/LinuxDisplay:unlockAWT	()V
    //   50: aload_2
    //   51: athrow
    // Line number table:
  ...
  private static boolean isXrandrSupported()
  {
    // Byte code:
    //   0: ldc 27
    //   2: invokestatic 28	org/lwjgl/opengl/Display:getPrivilegedBoolean	(Ljava/lang/String;)Z
    //   5: ifeq +5 -> 10
    //   8: iconst_0
    //   9: ireturn
    //   10: invokestatic 14	org/lwjgl/opengl/LinuxDisplay:lockAWT	()V
    //   13: invokestatic 15	org/lwjgl/opengl/LinuxDisplay:incDisplay	()V
    //   16: invokestatic 17	org/lwjgl/opengl/LinuxDisplay:getDisplay	()J
    //   19: invokestatic 29	org/lwjgl/opengl/LinuxDisplay:nIsXrandrSupported	(J)Z
    //   22: istore_0
    //   23: invokestatic 20	org/lwjgl/opengl/LinuxDisplay:decDisplay	()V
    //   26: invokestatic 21	org/lwjgl/opengl/LinuxDisplay:unlockAWT	()V
    //   29: iload_0
    //   30: ireturn
    //   31: astore_1
    //   32: invokestatic 20	org/lwjgl/opengl/LinuxDisplay:decDisplay	()V
    ...
    //   50: aload_0
    //   51: invokevirtual 35	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   54: invokevirtual 36	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   57: invokestatic 24	org/lwjgl/LWJGLUtil:log	(Ljava/lang/CharSequence;)V
    //   60: iconst_0
    //   61: istore_1
    //   62: invokestatic 21	org/lwjgl/opengl/LinuxDisplay:unlockAWT	()V
    //   65: iload_1
    //   66: ireturn
    //   67: astore_2
    //   68: invokestatic 21	org/lwjgl/opengl/LinuxDisplay:unlockAWT	()V
    //   71: aload_2
    //   72: athrow
    // Line number table:
  ...
  private static boolean isXF86VidModeSupported()
  {
    ...
    //   0: invokestatic 14	org/lwjgl/opengl/LinuxDisplay:lockAWT	()V
    //   3: invokestatic 15	org/lwjgl/opengl/LinuxDisplay:incDisplay	()V
    //   6: invokestatic 17	org/lwjgl/opengl/LinuxDisplay:getDisplay	()J
    //   9: invokestatic 37	org/lwjgl/opengl/LinuxDisplay:nIsXF86VidModeSupported	(J)Z
    //   12: istore_0
    //   13: invokestatic 20	org/lwjgl/opengl/LinuxDisplay:decDisplay	()V
    //   16: invokestatic 21	org/lwjgl/opengl/LinuxDisplay:unlockAWT	()V
    //   19: iload_0
    //   20: ireturn
    //   21: astore_1
    //   22: invokestatic 20	org/lwjgl/opengl/LinuxDisplay:decDisplay	()V
    ...
    //   26: athrow
    //   27: astore_0
    //   28: new 31	java/lang/StringBuilder
    //   31: dup
    ...
    //   40: aload_0
    //   41: invokevirtual 35	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   44: invokevirtual 36	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   47: invokestatic 24	org/lwjgl/LWJGLUtil:log	(Ljava/lang/CharSequence;)V
    //   50: iconst_0
    //   51: istore_1
    //   52: invokestatic 21	org/lwjgl/opengl/LinuxDisplay:unlockAWT	()V
    //   55: iload_1
    //   56: ireturn
    //   57: astore_2
    //   58: invokestatic 21	org/lwjgl/opengl/LinuxDisplay:unlockAWT	()V
    //   61: aload_2
    //   62: athrow
    // Line number table:
    ...
    throws LWJGLException
  {
    ...
    //   13: invokestatic 15	org/lwjgl/opengl/LinuxDisplay:incDisplay	()V
    //   16: invokestatic 17	org/lwjgl/opengl/LinuxDisplay:getDisplay	()J
    //   19: invokestatic 18	org/lwjgl/opengl/LinuxDisplay:getDefaultScreen	()I
    //   22: invokestatic 40	org/lwjgl/opengl/LinuxDisplay:nIsNetWMFullscreenSupported	(JI)Z
    //   25: istore_0
    //   26: invokestatic 20	org/lwjgl/opengl/LinuxDisplay:decDisplay	()V
    //   29: invokestatic 21	org/lwjgl/opengl/LinuxDisplay:unlockAWT	()V
    //   32: iload_0
    //   33: ireturn
    //   34: astore_1
    //   35: invokestatic 20	org/lwjgl/opengl/LinuxDisplay:decDisplay	()V
    //   38: aload_1
    //   39: athrow
    //   40: astore_0
    //   41: new 31	java/lang/StringBuilder
    //   44: dup
    //   45: invokespecial 32	java/lang/StringBuilder:<init>	()V
    //   48: ldc 41
    //   50: invokevirtual 34	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   53: aload_0
    //   54: invokevirtual 35	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   57: invokevirtual 36	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   60: invokestatic 24	org/lwjgl/LWJGLUtil:log	(Ljava/lang/CharSequence;)V
    //   63: iconst_0
    //   64: istore_1
    //   65: invokestatic 21	org/lwjgl/opengl/LinuxDisplay:unlockAWT	()V
    //   68: iload_1
    //   69: ireturn
    //   70: astore_2
    //   71: invokestatic 21	org/lwjgl/opengl/LinuxDisplay:unlockAWT	()V
    //   74: aload_2
    //   75: athrow
    // Line number table:
  ...
  {
    // Byte code:
    //   0: invokestatic 16	org/lwjgl/opengl/LinuxDisplay:isXF86VidModeSupported	()Z
    //   3: ifne +5 -> 8
    //   6: iconst_0
    //   7: ireturn
    //   8: invokestatic 14	org/lwjgl/opengl/LinuxDisplay:lockAWT	()V
    //   11: invokestatic 15	org/lwjgl/opengl/LinuxDisplay:incDisplay	()V
    //   14: invokestatic 17	org/lwjgl/opengl/LinuxDisplay:getDisplay	()J
    //   17: invokestatic 18	org/lwjgl/opengl/LinuxDisplay:getDefaultScreen	()I
    //   20: invokestatic 178	org/lwjgl/opengl/LinuxDisplay:nGetGammaRampLength	(JI)I
    //   23: istore_1
    //   24: invokestatic 20	org/lwjgl/opengl/LinuxDisplay:decDisplay	()V
    //   27: invokestatic 21	org/lwjgl/opengl/LinuxDisplay:unlockAWT	()V
    //   30: iload_1
    //   31: ireturn
    //   32: astore_1
    //   33: new 31	java/lang/StringBuilder
    //   36: dup
    //   37: invokespecial 32	java/lang/StringBuilder:<init>	()V
    //   40: ldc -77
    //   42: invokevirtual 34	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   45: aload_1
    //   46: invokevirtual 35	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   49: invokevirtual 36	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   52: invokestatic 24	org/lwjgl/LWJGLUtil:log	(Ljava/lang/CharSequence;)V
    //   55: iconst_0
    //   56: istore_2
    //   57: invokestatic 20	org/lwjgl/opengl/LinuxDisplay:decDisplay	()V
    //   60: invokestatic 21	org/lwjgl/opengl/LinuxDisplay:unlockAWT	()V
    //   63: iload_2
    //   64: ireturn
    //   65: astore_3
    //   66: invokestatic 20	org/lwjgl/opengl/LinuxDisplay:decDisplay	()V
    //   69: aload_3
    //   70: athrow
    //   71: astore_1
    //   72: new 31	java/lang/StringBuilder
    //   75: dup
    //   76: invokespecial 32	java/lang/StringBuilder:<init>	()V
    //   79: ldc -76
    //   81: invokevirtual 34	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   84: aload_1
    //   85: invokevirtual 35	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   88: invokevirtual 36	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   91: invokestatic 24	org/lwjgl/LWJGLUtil:log	(Ljava/lang/CharSequence;)V
    //   94: iconst_0
    //   95: istore_2
    //   96: invokestatic 21	org/lwjgl/opengl/LinuxDisplay:unlockAWT	()V
    //   99: iload_2
    //   100: ireturn
    //   101: astore 4
    //   103: invokestatic 21	org/lwjgl/opengl/LinuxDisplay:unlockAWT	()V
    //   106: aload 4
    //   108: athrow
    // Line number table:
    ...
    //   Java source line #676	-> byte code offset #55
    //   Java source line #678	-> byte code offset #57
    //   Java source line #685	-> byte code offset #60
    //   Java source line #678	-> byte code offset #65
    //   Java source line #680	-> byte code offset #71
    //   Java source line #681	-> byte code offset #72
    //   Java source line #682	-> byte code offset #94
    //   Java source line #685	-> byte code offset #96
    // Local variable table:
    //   start	length	slot	name	signature
    ...
    throws LWJGLException
  {
    ...
    //   3: invokestatic 15	org/lwjgl/opengl/LinuxDisplay:incDisplay	()V
    //   6: invokestatic 17	org/lwjgl/opengl/LinuxDisplay:getDisplay	()J
    //   9: invokestatic 18	org/lwjgl/opengl/LinuxDisplay:getDefaultScreen	()I
    //   12: invokestatic 201	org/lwjgl/opengl/LinuxDisplay:nGetCurrentXRandrMode	(JI)Lorg/lwjgl/opengl/DisplayMode;
    //   15: astore_0
    //   16: invokestatic 20	org/lwjgl/opengl/LinuxDisplay:decDisplay	()V
    //   19: invokestatic 21	org/lwjgl/opengl/LinuxDisplay:unlockAWT	()V
    //   22: aload_0
    //   23: areturn
    //   24: astore_1
    //   25: invokestatic 20	org/lwjgl/opengl/LinuxDisplay:decDisplay	()V
    //   28: aload_1
    //   29: athrow
    //   30: astore_2
    //   31: invokestatic 21	org/lwjgl/opengl/LinuxDisplay:unlockAWT	()V
    //   34: aload_2
    //   35: athrow
    // Line number table:
    ...
    throws LWJGLException
  {
    ...
    //   3: invokestatic 15	org/lwjgl/opengl/LinuxDisplay:incDisplay	()V
    //   6: aload_0
    //   7: getfield 8	org/lwjgl/opengl/LinuxDisplay:current_displaymode_extension	I
    //   10: bipush 10
    //   12: if_icmpne +109 -> 121
    //   15: invokestatic 17	org/lwjgl/opengl/LinuxDisplay:getDisplay	()J
    //   18: invokestatic 18	org/lwjgl/opengl/LinuxDisplay:getDefaultScreen	()I
    //   21: aload_0
    //   22: getfield 8	org/lwjgl/opengl/LinuxDisplay:current_displaymode_extension	I
    //   25: invokestatic 233	org/lwjgl/opengl/LinuxDisplay:nGetAvailableDisplayModes	(JII)[Lorg/lwjgl/opengl/DisplayMode;
    //   28: astore_1
    //   29: bipush 24
    //   31: istore_2
    //   32: aload_1
    ...
    //   38: iconst_0
    //   39: aaload
    //   40: invokevirtual 234	org/lwjgl/opengl/DisplayMode:getBitsPerPixel	()I
    //   43: istore_2
    //   44: invokestatic 235	org/lwjgl/opengl/XRandR:getScreenNames	()[Ljava/lang/String;
    //   47: iconst_0
    //   48: aaload
    //   49: invokestatic 236	org/lwjgl/opengl/XRandR:getResolutions	(Ljava/lang/String;)[Lorg/lwjgl/opengl/XRandR$Screen;
    //   52: astore_3
    //   53: aload_3
    //   54: arraylength
    //   55: anewarray 198	org/lwjgl/opengl/DisplayMode
    //   58: astore 4
    //   60: iconst_0
    //   61: istore 5
    //   63: iload 5
    ...
    //   71: aload 4
    //   73: iload 5
    //   75: new 198	org/lwjgl/opengl/DisplayMode
    //   78: dup
    //   79: aload_3
    //   80: iload 5
    //   82: aaload
    //   83: getfield 237	org/lwjgl/opengl/XRandR$Screen:width	I
    //   86: aload_3
    //   87: iload 5
    //   89: aaload
    //   90: getfield 238	org/lwjgl/opengl/XRandR$Screen:height	I
    //   93: iload_2
    //   94: aload_3
    //   95: iload 5
    //   97: aaload
    //   98: getfield 239	org/lwjgl/opengl/XRandR$Screen:freq	I
    //   101: invokespecial 240	org/lwjgl/opengl/DisplayMode:<init>	(IIII)V
    //   104: aastore
    //   105: iinc 5 1
    //   108: goto -45 -> 63
    //   111: aload 4
    //   113: astore 5
    //   115: invokestatic 21	org/lwjgl/opengl/LinuxDisplay:unlockAWT	()V
    //   118: aload 5
    //   120: areturn
    //   121: invokestatic 17	org/lwjgl/opengl/LinuxDisplay:getDisplay	()J
    //   124: invokestatic 18	org/lwjgl/opengl/LinuxDisplay:getDefaultScreen	()I
    //   127: aload_0
    //   128: getfield 8	org/lwjgl/opengl/LinuxDisplay:current_displaymode_extension	I
    //   131: invokestatic 233	org/lwjgl/opengl/LinuxDisplay:nGetAvailableDisplayModes	(JII)[Lorg/lwjgl/opengl/DisplayMode;
    //   134: astore_1
    //   135: aload_1
    //   136: astore_2
    //   137: invokestatic 20	org/lwjgl/opengl/LinuxDisplay:decDisplay	()V
    //   140: invokestatic 21	org/lwjgl/opengl/LinuxDisplay:unlockAWT	()V
    //   143: aload_2
    //   144: areturn
    //   145: astore 6
    //   147: invokestatic 20	org/lwjgl/opengl/LinuxDisplay:decDisplay	()V
    //   150: aload 6
    //   152: athrow
    //   153: astore 7
    //   155: invokestatic 21	org/lwjgl/opengl/LinuxDisplay:unlockAWT	()V
    //   158: aload 7
    //   160: athrow
    // Line number table:
  ...
  public int getNativeCursorCapabilities()
  {
    ...
    //   3: invokestatic 15	org/lwjgl/opengl/LinuxDisplay:incDisplay	()V
    //   6: invokestatic 17	org/lwjgl/opengl/LinuxDisplay:getDisplay	()J
    //   9: invokestatic 265	org/lwjgl/opengl/LinuxDisplay:nGetNativeCursorCapabilities	(J)I
    //   12: istore_1
    //   13: invokestatic 20	org/lwjgl/opengl/LinuxDisplay:decDisplay	()V
    //   16: invokestatic 21	org/lwjgl/opengl/LinuxDisplay:unlockAWT	()V
    //   19: iload_1
    ...
    //   26: athrow
    //   27: astore_1
    //   28: new 266	java/lang/RuntimeException
    //   31: dup
    //   32: aload_1
    //   33: invokespecial 267	java/lang/RuntimeException:<init>	(Ljava/lang/Throwable;)V
    //   36: athrow
    //   37: astore_3
    //   38: invokestatic 21	org/lwjgl/opengl/LinuxDisplay:unlockAWT	()V
    //   41: aload_3
    //   42: athrow
    // Line number table:
  ...
  public int getMinCursorSize()
  {
    ...
    //   3: invokestatic 15	org/lwjgl/opengl/LinuxDisplay:incDisplay	()V
    //   6: invokestatic 17	org/lwjgl/opengl/LinuxDisplay:getDisplay	()J
    //   9: invokestatic 78	org/lwjgl/opengl/LinuxDisplay:getWindow	()J
    //   12: invokestatic 269	org/lwjgl/opengl/LinuxDisplay:nGetMinCursorSize	(JJ)I
    //   15: istore_1
    //   16: invokestatic 20	org/lwjgl/opengl/LinuxDisplay:decDisplay	()V
    //   19: invokestatic 21	org/lwjgl/opengl/LinuxDisplay:unlockAWT	()V
    //   22: iload_1
    ...
    //   44: aload_1
    //   45: invokevirtual 35	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   48: invokevirtual 36	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   51: invokestatic 24	org/lwjgl/LWJGLUtil:log	(Ljava/lang/CharSequence;)V
    //   54: iconst_0
    //   55: istore_2
    //   56: invokestatic 21	org/lwjgl/opengl/LinuxDisplay:unlockAWT	()V
    //   59: iload_2
    //   60: ireturn
    //   61: astore_3
    //   62: invokestatic 21	org/lwjgl/opengl/LinuxDisplay:unlockAWT	()V
  ...
  public int getMaxCursorSize()
  {
    ...
    //   6: invokestatic 17	org/lwjgl/opengl/LinuxDisplay:getDisplay	()J
    //   9: invokestatic 78	org/lwjgl/opengl/LinuxDisplay:getWindow	()J
    //   12: invokestatic 271	org/lwjgl/opengl/LinuxDisplay:nGetMaxCursorSize	(JJ)I
    //   15: istore_1
    //   16: invokestatic 20	org/lwjgl/opengl/LinuxDisplay:decDisplay	()V
    //   19: invokestatic 21	org/lwjgl/opengl/LinuxDisplay:unlockAWT	()V
    //   22: iload_1
    ...
    throws LWJGLException
  {
    ...
    //   16: aload 6
    //   18: aload 6
    //   20: invokevirtual 279	java/nio/IntBuffer:position	()I
    //   23: aload 7
    //   25: aload 7
    //   27: ifnull +11 -> 38
    //   30: aload 7
    //   32: invokevirtual 279	java/nio/IntBuffer:position	()I
    //   35: goto +4 -> 39
    //   38: iconst_m1
    //   39: invokestatic 280	org/lwjgl/opengl/LinuxDisplay:nCreateCursor	(JIIIIILjava/nio/IntBuffer;ILjava/nio/IntBuffer;I)J
    //   42: lstore 8
    //   44: lload 8
    //   46: invokestatic 281	java/lang/Long:valueOf	(J)Ljava/lang/Long;
    //   49: astore 10
    //   51: invokestatic 21	org/lwjgl/opengl/LinuxDisplay:unlockAWT	()V
    //   54: aload 10
    //   56: areturn
    //   57: astore 8
    //   59: invokestatic 20	org/lwjgl/opengl/LinuxDisplay:decDisplay	()V
    //   62: aload 8
    //   64: athrow
    //   65: astore 11
    //   67: invokestatic 21	org/lwjgl/opengl/LinuxDisplay:unlockAWT	()V
    //   70: aload 11
    //   72: athrow
    // Line number table:
  ...
  public int getPbufferCapabilities()
  {
    ...
    //   6: invokestatic 17	org/lwjgl/opengl/LinuxDisplay:getDisplay	()J
    //   9: invokestatic 18	org/lwjgl/opengl/LinuxDisplay:getDefaultScreen	()I
    //   12: invokestatic 284	org/lwjgl/opengl/LinuxDisplay:nGetPbufferCapabilities	(JI)I
    //   15: istore_1
    //   16: invokestatic 20	org/lwjgl/opengl/LinuxDisplay:decDisplay	()V
    //   19: invokestatic 21	org/lwjgl/opengl/LinuxDisplay:unlockAWT	()V
    //   22: iload_1
  ...
  public int setIcon(ByteBuffer[] icons)
  {
    ...
    //   3: invokestatic 15	org/lwjgl/opengl/LinuxDisplay:incDisplay	()V
    //   6: aload_1
    //   7: invokestatic 298	org/lwjgl/opengl/LinuxDisplay:convertIcons	([Ljava/nio/ByteBuffer;)Ljava/nio/ByteBuffer;
    //   10: astore_2
    //   11: aload_2
    //   12: ifnonnull +13 -> 25
    //   15: iconst_0
    //   16: istore_3
    //   17: invokestatic 20	org/lwjgl/opengl/LinuxDisplay:decDisplay	()V
    //   20: invokestatic 21	org/lwjgl/opengl/LinuxDisplay:unlockAWT	()V
    //   23: iload_3
    //   24: ireturn
    //   25: invokestatic 17	org/lwjgl/opengl/LinuxDisplay:getDisplay	()J
    //   28: invokestatic 78	org/lwjgl/opengl/LinuxDisplay:getWindow	()J
    //   31: aload_2
    //   32: aload_2
    //   33: invokevirtual 299	java/nio/ByteBuffer:capacity	()I
    //   36: invokestatic 300	org/lwjgl/opengl/LinuxDisplay:nSetWindowIcon	(JJLjava/nio/ByteBuffer;I)V
    //   39: aload_1
    //   40: arraylength
    //   41: istore_3
    //   42: invokestatic 20	org/lwjgl/opengl/LinuxDisplay:decDisplay	()V
    //   45: invokestatic 21	org/lwjgl/opengl/LinuxDisplay:unlockAWT	()V
    //   48: iload_3
    //   49: ireturn
    //   50: astore 4
    //   52: invokestatic 20	org/lwjgl/opengl/LinuxDisplay:decDisplay	()V
    //   55: aload 4
    //   57: athrow
    //   58: astore_2
    //   59: new 31	java/lang/StringBuilder
    //   62: dup
    //   63: invokespecial 32	java/lang/StringBuilder:<init>	()V
    //   66: ldc_w 301
    //   69: invokevirtual 34	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   72: aload_2
    //   73: invokevirtual 35	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   76: invokevirtual 36	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   79: invokestatic 24	org/lwjgl/LWJGLUtil:log	(Ljava/lang/CharSequence;)V
    //   82: iconst_0
    //   83: istore_3
    //   84: invokestatic 21	org/lwjgl/opengl/LinuxDisplay:unlockAWT	()V
    //   87: iload_3
    //   88: ireturn
    //   89: astore 5
    //   91: invokestatic 21	org/lwjgl/opengl/LinuxDisplay:unlockAWT	()V
    //   94: aload 5
    //   96: athrow
    // Line number table:
