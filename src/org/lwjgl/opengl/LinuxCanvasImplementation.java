  ...
  implements AWTCanvasImplementation
{
  ...
  {
    // Byte code:
    //   0: invokestatic 28	org/lwjgl/opengl/LinuxDisplay:lockAWT	()V
    //   3: invokestatic 29	org/lwjgl/opengl/GLContext:loadOpenGLLibrary	()V
    //   6: invokestatic 30	org/lwjgl/opengl/LinuxDisplay:incDisplay	()V
    //   9: invokestatic 31	org/lwjgl/opengl/LinuxDisplay:getDisplay	()J
    //   12: iload_0
    //   13: aload_1
    //   14: invokestatic 32	org/lwjgl/opengl/LinuxCanvasImplementation:nFindVisualIDFromFormat	(JILorg/lwjgl/opengl/PixelFormat;)I
    //   17: istore_2
    //   18: invokestatic 33	org/lwjgl/opengl/LinuxDisplay:decDisplay	()V
    //   21: invokestatic 34	org/lwjgl/opengl/GLContext:unloadOpenGLLibrary	()V
    //   24: invokestatic 35	org/lwjgl/opengl/LinuxDisplay:unlockAWT	()V
    //   27: iload_2
    //   28: ireturn
    //   29: astore_3
    //   30: invokestatic 33	org/lwjgl/opengl/LinuxDisplay:decDisplay	()V
    //   33: aload_3
    //   34: athrow
    //   35: astore 4
    //   37: invokestatic 34	org/lwjgl/opengl/GLContext:unloadOpenGLLibrary	()V
    //   40: aload 4
    //   42: athrow
    //   43: astore 5
    //   45: invokestatic 35	org/lwjgl/opengl/LinuxDisplay:unlockAWT	()V
    //   48: aload 5
    //   50: athrow
    // Line number table:
